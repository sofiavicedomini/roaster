...
export async function GET() {
    const data = {
        ...
        apis: [
            {
                ...
                description: "Model Context Protocol server for AI agent integration. Stable, public API for programmatic access.",
                url: "/api/mcp",
                methods: ["POST"],
                public: true,
        ...
        humanInterface: {
            ...
            description: "Use the web UI to analyze websites. Results are available as JSON or Markdown via content negotiation on individual ranking pages (/[lang]/rankings/[uuid]) by sending Accept: application/json or Accept: text/markdown."
        },
        contentNegotiation: {
            ...
            formats: [
                ...
                { accept: "application/vnd.api+json", returns: "Raw roast result with agent metadata" },
        ...
        agentDiscovery: {
            ...
            instructions: "AI agents should discover the MCP server at /.well-known/mcp.json and use /api/mcp for all API interactions. Use /api/summary for statistics and /api/info for company/service information."
        },
        headers: {
