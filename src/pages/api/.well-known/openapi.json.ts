            ...
            schemas: {
                JobResponse: {
                    ...
                    properties: {
                        ...
                        status: { type: "string", enum: ["pending", "processing", "resuming"], description: "Current job status" },
                        cached: { type: "boolean", description: "Whether result was served from cache" }
                    }
                },
                JobStatusResponse: {
                    type: "object",
                    properties: {
                        status: { type: "string", enum: ["pending", "processing", "completed", "failed"], description: "Job status" },
                        progress: { type: "string", description: "Current progress message" },
                ...
                MCPRequest: {
                    ...
                    properties: {
                        method: {
                            type: "string",
                            enum: ["initialize", "analyzeWebsite", "getRoastResult", "listRecentRoasts", "getRoastWithLocale"]
                        },
                        params: {
                            type: "object",
                            properties: {
