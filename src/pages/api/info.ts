...
export const howItWorks = [
  {
    ...
    description: "Paste any public website address. If it's your own site, brace yourself.",
    details: "The URL must be a valid, publicly accessible website. The AI will analyze whatever it can reach."
  },
  {
    step: 2,
    title: "AI Scrapes & Analyzes",
    description: "Our AI fetches your site's content, checks robots.txt, sitemap, performance, agent compatibility, and everything it can find.",
    details: "The AI reads everything. It judges everything. It checks design, performance, code quality, mobile responsiveness, UX, accessibility, SEO, copywriting, brand credibility, security, and AI agent readiness."
  },
  {
    step: 3,
    title: "The Roast",
    description: "Each selected category gets a score from 1 to 10, a brutal critique, and a prompt you can give an AI agent to actually fix it.",
    details: "No sugar-coating. The critique is honest, specific, and evidence-based. The fix prompt is actionable and can be given to an AI agent to implement."
  },
  {
    step: 4,
    title: "Your Score",
    description: "Get your overall score, share the result, or quietly fix your site in the dark.",
    details: "The overall score is an average of all category scores. Share it proudly (or hide it in shame). Either way, you now know what needs fixing."
  }
];
...
export const categories = [
  {
    id: "design",
    name: "Design & UI",
    description: "Visual design, layout, color choices, typography, and overall aesthetic appeal"
  },
  {
    id: "performance",
  ...
  },
  {
    id: "accessibility",
    name: "Accessibility",
    description: "WCAG compliance and accessibility for users with disabilities"
  },
  {
    id: "conversion",
  ...
  },
  {
    ...
    description: "Proper robots.txt and sitemap.xml configuration for AI crawlers"
  },
  {
    id: "mcp",
  ...
  },
  {
    id: "apiDiscovery",
    name: "API Discovery",
    description: "API documentation and discovery mechanisms (llms.txt, OpenAPI)"
  },
  {
    id: "botAuth",
...
export const GET: APIRoute = async ({ request }) => {
  ...
  if (type === "minimal") {
    const minimalResponse = {
      ...
      howItWorks: howItWorks.map(h => ({ step: h.step, title: h.title, description: h.description })),
